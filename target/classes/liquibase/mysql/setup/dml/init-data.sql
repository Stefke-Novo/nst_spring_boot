...
insert into member (id, first_name, last_name, department_id, education_title_id)
values (0,'First name 1','Last name 1',(select id from department where name='Department 1'), (select id from education_title where title = 'Education title 1'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (1,'First name 2','Last name 2',(select id from department where name='Department 1'), (select id from education_title where title = 'Education title 2'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (2,'First name 3','Last name 3',(select id from department where name='Department 2'), (select id from education_title where title = 'Education title 3'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (3,'First name 4','Last name 4',(select id from department where name='Department 2'), (select id from education_title where title = 'Education title 4'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (4,'First name 5','Last name 5',(select id from department where name='Department 3'), (select id from education_title where title = 'Education title 5'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (5,'First name 6','Last name 6',(select id from department where name='Department 3'), (select id from education_title where title = 'Education title 1'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (6,'First name 7','Last name 7',(select id from department where name='Department 4'), (select id from education_title where title = 'Education title 2'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (7,'First name 8','Last name 8',(select id from department where name='Department 4'), (select id from education_title where title = 'Education title 3'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (8,'First name 9','Last name 9',(select id from department where name='Department 5'), (select id from education_title where title = 'Education title 4'));
insert into member (id,first_name, last_name, department_id, education_title_id)
values (9,'First name 10','Last name 10',(select id from department where name='Department 5'), (select id from education_title where title = 'Education title 5'));

insert into head_of_department select department_id,id from member where first_name = 'First name 1' and last_name = 'Last name 1';
insert into head_of_department select department_id,id from member where first_name = 'First name 2' and last_name = 'Last name 2';
insert into head_of_department select department_id,id from member where first_name = 'First name 3' and last_name = 'Last name 3';

insert into department_secretary select department_id,id from member where first_name = 'First name 4' and last_name = 'Last name 4';
insert into department_secretary select department_id,id from member where first_name = 'First name 5' and last_name = 'Last name 5';
insert into department_secretary select department_id,id from member where first_name = 'First name 6' and last_name = 'Last name 6';
...
insert into academic_title_history (department_id, member_id, academic_title_id, start_date, end_date, scientific_field_id)
values (
